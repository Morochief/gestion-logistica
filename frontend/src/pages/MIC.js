...
const OPCIONES_AUDANA = ["BRASIL - MULTILOG - FOZ DO IGUAZU 508 - 030"];
const OPCIONES_BULTOS = ["CAJA", "PALLET", "A GRANEL"];
...
const CAMPOS_MANUALES = [
  1, 5, 6, 8, 13, 16, 17, 18, 19, 20, 21, 22, 23, 25, 26, 27, 28, 29, 32, 33,
  34, 35, 36, 38, 39, 41,
];
...
export default function MIC({ crtId, crtNumero, onClose, modo = "generar" }) {
  ...
  const generarPDFTemporal = async () => {
    ...
    try {
      ...
      const res = await axios.post(endpoint, micToSend, {
        responseType: "blob",
      });
  ...
  const descargarPDFGuardado = async (micId) => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/api/mic/${micId}/pdf`, {
        responseType: "blob",
      });
      ...
      link.href = url;
      link.download = `MIC_${mic.campo_23_numero_campo2_crt || micId}_${
  ...
  return (
    <form className="mic-form-pro" onSubmit={(e) => e.preventDefault()}>
      ...
      <div className="mic-status-indicators">
        ...
        {datosCRT && !cargandoCRT && (
          <div className="status-indicator success">
            <span>
              ✅ CRT {datosCRT.numero_crt} cargado -{" "}
              {camposAutocompletados.length} campos auto-completados
            </span>
            <button
              type="button"
        ...
        {camposAutocompletados.length > 0 && (
          <div className="auto-completed-info">
            <details>
              <summary>
                📋 Campos auto-completados ({camposAutocompletados.length})
              </summary>
              <ul>
                {camposAutocompletados.map((campo) => (
                  <li key={campo}>
                    {campo.replace("campo_", "Campo ").replace(/_/g, " ")}
                  </li>
                ))}
              </ul>
            </details>
      ...
      <div className="mic-form-grid">
        ...
        <label>
          <div className="field-header">
            ...
            {esCampoAutocompletado("campo_2_numero") && (
        ...
        <label>
          <div className="field-header">
            ...
            {esCampoAutocompletado("campo_3_transporte") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          <div className="field-header">
            Campo 4 (Estado)
            {esCampoAutocompletado("campo_4_estado") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <select
            name="campo_4_estado"
            value={mic.campo_4_estado}
            onChange={handleChange}
            className="inputPro"
          >
        ...
        <label>
          <div className="field-header">
            Campo 7 (Pto Seguro) *
            {esCampoAutocompletado("campo_7_pto_seguro") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <select
            name="campo_7_pto_seguro"
            value={mic.campo_7_pto_seguro}
            onChange={handleChange}
            required
            className="inputPro"
          >
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_8_destino") && (
            <small className="auto-help">
              Auto-completado desde lugar_entrega del CRT
            </small>
          )}
        </label>
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_9_datos_transporte") && (
            <small className="auto-help">
              Auto-completado desde transportadora del CRT
            </small>
          )}
        </label>
        ...
        <label>
          <div className="field-header">
            ...
            {esCampoAutocompletado("campo_10_numero") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          <div className="field-header">
            Campo 11 (Placa) *
            {esCampoAutocompletado("campo_11_placa") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          <div className="field-header">
            ...
            {esCampoAutocompletado("campo_12_modelo_chasis") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setMic({
                  ...mic,
                  campo_12_chasis: chasis,
                  campo_12_modelo_chasis: combined,
                });
              }}
              className="inputPro"
        ...
        <label>
          <div className="field-header">
            Campo 14 (Año) *
            {esCampoAutocompletado("campo_14_anio") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          <div className="field-header">
            Campo 15 (Placa Semi) *
            {esCampoAutocompletado("campo_15_placa_semi") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_23_numero_campo2_crt") && (
            <small className="auto-help">
              Auto-completado desde número_crt
            </small>
          )}
        </label>
        ...
        <label>
          <div className="field-header">
            Campo 24 (Aduana) *
            {esCampoAutocompletado("campo_24_aduana") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <select
            name="campo_24_aduana"
            value={mic.campo_24_aduana}
            onChange={handleChange}
            required
            className="inputPro"
          >
            <option value="">Seleccione...</option>
            {OPCIONES_AUDANA.map((opt) => (
              <option key={opt} value={opt}>
                {opt}
              </option>
            ))}
        ...
        <label>
          ...
          <select
            name="campo_25_moneda"
            value={mic.campo_25_moneda}
            onChange={handleChange}
            className="inputPro"
          >
          ...
          {esCampoAutocompletado("campo_25_moneda") && (
            <small className="auto-help">
              Auto-completado desde moneda del CRT
            </small>
          )}
        </label>
        ...
        <label>
          <div className="field-header">
            ...
            {esCampoAutocompletado("campo_26_pais") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_27_valor_campo16") && (
            <small className="auto-help">
              Auto-completado desde declaracion_mercaderia del CRT
            </small>
          )}
        </label>
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_28_total") && (
            <small className="auto-help">
              Auto-calculado desde gastos del CRT (suma de no-seguros)
            </small>
          )}
        </label>
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_29_seguro") && (
            <small className="auto-help">
              Auto-calculado desde gastos del CRT (solo seguros)
            </small>
          )}
        </label>
        ...
        <label>
          <div className="field-header">
            ...
            {esCampoAutocompletado("campo_30_tipo_bultos") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <select
            name="campo_30_tipo_bultos"
            value={mic.campo_30_tipo_bultos}
            onChange={handleChange}
            required
            className="inputPro"
          >
            <option value="">Seleccione...</option>
            {OPCIONES_BULTOS.map((opt) => (
              <option key={opt} value={opt}>
                {opt}
              </option>
            ))}
        ...
        <label>
          <div className="field-header">
            Campo 31 (Cantidad) *
            {esCampoAutocompletado("campo_31_cantidad") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          ...
          {esCampoAutocompletado("campo_32_peso_bruto") && (
            <small className="auto-help">
              Auto-completado desde peso_bruto del CRT
            </small>
          )}
        </label>
        ...
        <label style={{ gridColumn: "span 2" }}>
          ...
          {esCampoAutocompletado("campo_36_factura_despacho") && (
            <small className="auto-help">
              Auto-completado desde factura_exportacion y nro_despacho del CRT
            </small>
          )}
        </label>
        ...
        <label>
          <div className="field-header">
            Campo 37 (Manual)
            {esCampoAutocompletado("campo_37_valor_manual") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <input
        ...
        <label>
          <div className="field-header">
            Campo 40 (Tramo) *
            {esCampoAutocompletado("campo_40_tramo") && (
              <span className="auto-badge">✅ Auto</span>
            )}
          </div>
          <select
            name="campo_40_tramo"
            value={mic.campo_40_tramo}
            onChange={handleChange}
            required
            className="inputPro"
          >
            <option value="">Seleccione...</option>
            {OPCIONES_TRAMOS.map((opt) => (
              <option key={opt} value={opt}>
                {opt}
              </option>
            ))}
      ...
      <h3 className="font-bold text-sm mb-2">
        Campos adicionales manuales (opcional)
      </h3>
      <div className="mic-form-grid">
      ...
      <div className="mic-form-actions">
        ...
        {onClose && (
          <button type="button" onClick={onClose} className="mic-btn-cancel">
            Cancelar
          </button>
        )}
      </div>
      ...
      <div className="mic-help-info">
        <div className="help-section">
          ...
          <ul>
            <li>
              <strong>💾 Guardar MIC:</strong> Guarda el MIC en la base de datos
              con datos integrados del CRT
            </li>
            <li>
              <strong>👁️ Vista Previa PDF:</strong> Genera un PDF temporal
              usando la integración automática
            </li>
            <li>
              <strong>🔄 Recarga:</strong> Usa el botón de recarga para
              actualizar datos del CRT
            </li>
            <li>
              Los campos con <span className="auto-badge-demo">✅ Auto</span> se
              completan automáticamente desde el CRT
            </li>
            <li>Los campos marcados con * son obligatorios</li>
            <li>
              <strong>💰 Gastos:</strong> Los campos 28 (Flete) y 29 (Seguro) se
              calculan automáticamente desde los gastos del CRT
            </li>
          </ul>
        </div>
          ...
          <div className="help-section">
            ...
            <div className="integration-summary">
              ...
              <div className="summary-item">
                ...
                {datosCRT.transportadora?.nombre || "N/A"}
              </div>
              <div className="summary-item">
                <strong>Remitente:</strong>{" "}
                {datosCRT.remitente?.nombre || "N/A"}
              </div>
              <div className="summary-item">
                <strong>Campos auto-completados:</strong>{" "}
                {camposAutocompletados.length}
              </div>
              {(datosCRT.campo_28_total || datosCRT.campo_29_seguro) && (
                <div className="summary-item">
                  <strong>Gastos procesados:</strong>
                  {datosCRT.campo_28_total &&
                    ` Flete: ${datosCRT.campo_28_total}`}
                  {datosCRT.campo_29_seguro &&
                    ` | Seguro: ${datosCRT.campo_29_seguro}`}
                </div>
              )}
            </div>
          </div>
